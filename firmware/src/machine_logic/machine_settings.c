...
static void _machine_settings_print_ln(uint ln_num){
    ...
    case LN_AB_LEG_1:
        ...
        printf("\033[%d;1H\033[2K|%d|%s: %5.1f : %5.1f | %4.2f :   %4.1f   : %4.1f |  %4.1f   |\n",
            ...
            _ms[offset + MS_A1_REF_START_per_100mlps_10bar]/(ref_scales[_ms[offset+MS_A1_REF_STYLE_ENM]]),
            _ms[offset + MS_A1_REF_END_per_100mlps_10bar]/(ref_scales[_ms[offset+MS_A1_REF_STYLE_ENM]]),
